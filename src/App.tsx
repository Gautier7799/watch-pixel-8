...
import { Watch, Store, Sliders, RefreshCw, Sparkles, Smartphone, Eye, Download, Code2 } from 'lucide-react';
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-neutral-400 truncate">
                {lang === 'ar' ? 'انقر لفتح المحاكي الحقيقي والمستشعرات' : 'Tap to open live watch & sensors'}
              </p>
            </div>
          </div>
